...
<head>
    <title>About us - AnimeCode</title>
                ...
                <div class="container">
                    <div class="information_page-wrap medium-page">
                        ...
                        <article class="article-infor">
                            <h1 class="h2-heading">「 𝗔𝗡𝗜𝗠𝗘 𝗢𝗖𝗘𝗔𝗡 」</h1>
							<div class="c4-button">
                  <a href="https://telegram.me/Anime_Ocean_Network" class="btn btn-radius btn-focus"><i class="fa fa-sign-in-alt mr-2"></i>Anime Ocean</a>
                    </div>
                            <p>ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴀɴɪᴍᴇ ᴏᴄᴇᴀɴ ɴᴇᴛᴡᴏʀᴋ.<br />
							ᴡᴇ ᴀʀᴇ ᴀ ᴀɴɪᴍᴇ ᴄᴏᴍᴍᴜɴɪᴛʏ ᴍᴀᴅᴇ ʙʏ.<br />
							ᴡᴇᴇʙs ғᴏʀ ᴡᴇᴇʙs ᴛᴏ sᴜᴘᴘᴏʀᴛ ᴀɴɪᴍᴇ.<br />
							& ᴄᴜʟᴛᴜʀᴇ ᴛʜʀᴏᴜɢʜ ᴏᴜᴛ ᴛʜᴇ ᴏᴄᴇᴀɴs</p>
                            <p>&nbsp;</p>
                            <h2 class="h2-heading">「 Team Warlords 」</h2>
<div class="c4-button">
                  <a href="https://telegram.me/teamwarlords" class="btn btn-radius btn-focus"><i class="fa fa-star mr-2"></i>Warlords Network</a>
                    </div>
                            <ul>
							
                                <li>ᴡᴀʀʟᴏʀᴅs ɪs ᴀɴ ᴀɴɪᴍᴇ ᴄᴏᴍᴍᴜɴɪᴛʏ ᴡʜɪᴄʜ ɪs ᴀ sᴇʀᴠɪᴄᴇ ᴘʀᴏᴠɪᴅɪɴɢ ɴᴇᴛᴡᴏʀᴋ ғᴏʀ ᴀɴɪᴍᴇ ʀᴇʟᴀᴛᴇᴅ sᴛᴜғғs ᴀᴄʀᴏss ᴅɪғғᴇʀᴇɴᴛ ᴘʟᴀᴛғᴏʀᴍs.</li>
                                
                                <li>ɪᴛ ɪs ᴀ ᴄᴏᴍᴍᴜɴɪᴛʏ ᴍᴀᴅᴇ ғᴏʀ ᴛʜᴇ ᴜᴘʙʀɪɴɢɪɴɢ ᴏғ ᴀɴɪᴍᴇs ɪɴ ɪɴᴅɪᴀ ʟᴇɢᴀʟʟʏ ᴀɴᴅ sᴘʀᴇᴀᴅ ɪᴛ ᴀᴄʀᴏss ᴛʜᴇ ɢʟᴏʙᴇ.</li>
