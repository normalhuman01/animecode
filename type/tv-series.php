...
<head>
    <title>Tv Series on AnimeCode</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Tv Series on AnimeCode">
    ...
    <meta property="og:title" content="Tv Series on AnimeCode">
    <meta property="og:description" content="Tv Series on AnimeCode in HD with No Ads. Watch anime online">
                    ...
                    <section class="block_area block_area_category">
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                <?php 
                                 $ch = curl_init();
								  curl_setopt($ch, CURLOPT_URL, "$api/season/tv-series?page=$page");
                               ...
                               // $json = json_decode($json, true);
                                foreach((array) $json as $key => $tvSeries) { ?>
                                    <div class="flw-item">
                                        ...
                                        <div class="tick ltr">
                                            ...
                                            <img class="film-poster-img lazyload"
                                                data-src="https://ik.imagekit.io/<?=$imgk?>/tr:f-webp/<?=$tvSeries['imgUrl']?>"
                                                src="<?=$cdn?>/images/no_poster.jpg"
                                                alt="Stream <?=$tvSeries['animeTitle']?> free online AnimeCode">
