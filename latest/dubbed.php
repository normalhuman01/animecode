...
<head>
    <title>Latest Dubbed on AnimeCode</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Latest Dubbed on AnimeCode">
    ...
    <meta property="og:title" content="Latest Dubbed on AnimeCode">
    <meta property="og:description" content="Latest Dubbed on AnimeCode in HD with No Ads. Watch anime online">
                    ...
                    <section class="block_area block_area_category">
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                foreach((array) $json as $key => $dubbed) { ?>
                                    <div class="flw-item">
                                        ...
                                        <div class="tick ltr">
                                            ...
                                            <img class="film-poster-img lazyload"
                                                data-src="https://ik.imagekit.io/<?=$imgk?>/tr:f-webp/<?=$dubbed['imgUrl']?>"
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
										$ch = curl_init();
								  curl_setopt($ch, CURLOPT_URL, "$api/recent-release-page?page=$page&type=2");
								  curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
								  curl_setopt($ch, CURLOPT_HEADER, FALSE);
								  curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type: application/json"));
								  $dubbedPage = curl_exec($ch);
