...
<head>
    <title>Latest Subbed on AnimeCode</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Latest Subbed on AnimeCode">
    ...
    <meta property="og:title" content="Latest Subbed on AnimeCode">
    <meta property="og:description" content="Latest Subbed on AnimeCode in HD with No Ads. Watch anime online">
                    ...
                    <section class="block_area block_area_category">
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                //$json = file_get_contents("$api/recent-release?type=1&page=$page");
                                //$json = json_decode($json, true);
                                foreach((array) $json as $key => $subbed) { ?>
                                    <div class="flw-item">
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
										$ch = curl_init();
								  curl_setopt($ch, CURLOPT_URL, "$api/recent-release-page?page=$page&type=1");
								  curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
								  curl_setopt($ch, CURLOPT_HEADER, FALSE);
								  curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type: application/json"));
								  $subbedPage = curl_exec($ch);
								  $subbedPage = json_decode($subbedPage, true);
                                         //  $subbedPage = file_get_contents("$api/recent-release-page?page=$page&type=1");
                                         //  $subbedPage = json_decode($subbedPage, true); 
										   { ?>
                                             <?=$subbedPage['pagination']; ?>
                                           <?php } curl_close($ch); ?>
                                        </ul>
                                    </nav>
                                </div>
