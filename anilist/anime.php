...
<head>
    <title>Watch <?=$title['romaji']?> - AnimeCode</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Watch <?=$title['romaji']?> - AnimeCode" />
    <meta name="description" content="<?=substr($getAnime['description'],0, 90)?>.... Read More On AnimeCode" />
    ...
    <meta property="og:title" content="Watch <?=$title['romaji']?> - AnimeCode">
    <meta property="og:description" content="<?=substr($getAnime['description'],0, 90)?>.... Read More On AnimeCode.">
    ...
    <meta property="twitter:title" content="Watch <?=$title['romaji']?> - AnimeCode">
    <meta property="twitter:description" ontent="<?=substr($getAnime['description'],0, 90)?>.... Read More On AnimeCode.">
