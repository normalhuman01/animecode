                        ...
                        <div class="anis-content">
                            ...
                            <div class="anisc-detail">
                                ...
                                <div class="film-buttons">
                                    <a href="<?=$websiteUrl?>/watch/<?php foreach(array_slice($episodelist, 0, 1) as $episode1) {?><?=$episode1['id']?><?php } ?>" class="btn btn-radius btn-primary btn-play"><i
											...
											<button id="save-to-playlist-button" onclick="saveToPlaylist('Anime List', '<?=$title['romaji']?>', 'https://the.animecode.com/anilist/anime?id=<?=$id?>', 'https://ik.imagekit.io/<?=$imgk?>/tr:w-100,tr:f-webp/<?=$getAnime['image']?>');checkIfBookmarked('Anime List', '<?=$title['romaji']?>')" class="btn btn-radius btn-primary btn-play"><i
                                            class="fas fa-bookmark mr-2"></i>Watch later</button>
											
                                            <div class="dr-fav" id="watch-list-content"><a target="_blank" href="https://list.animecode.com/search/anime/<?=$id?>"><i class="fas fa-list mr-2"></i>ListZia</a></div>
                                </div>
                                <?php } ?>
								<script>
                                ...
                                <div class="film-text m-hide">AnimeCode is a site to watch online anime like <strong><?=$title['romaji']?></strong> online, or you can even watch <strong><?=$title['romaji']?></strong> in HD quality</div>
                            ...
                            <div class="anisc-info-wrap">
                                <div class="anisc-info">
                                    ...
                                    <div class="film-text w-hide">AnimeCode is a site to watch online anime like <strong><?=$title['romaji']?></strong> online, or you can even watch <strong><?=$title['romaji']?></strong> in HD quality</div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="clearfix"></div>
